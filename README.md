...
![Панель управления](image/dashboard.png)
...
![Мониторинг системы](image/monitoring.png)
...
![Запуск MineAdmin](image/startup.png)
...
![Создание аккаунта](image/login.png)

![Терминал сервера](image/terminal.png)

![Файловый менеджер](image/file-manager.png)
